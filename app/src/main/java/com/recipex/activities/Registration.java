 ...
 */
public class Registration extends ActionBarActivity implements LoginTC, View.OnClickListener{
    ...
    /**
     * initialize layout elements, and fill fields with data I already have (name, surname, picture, email)
            ...
            if (inserisciNome.getText().length() > 1 && inserisciCognome.getText().length() > 1 &&
                ...
                if (credential.getSelectedAccountName() == null) {
                    ...
                    if (AppConstants.checkNetwork(this)) {
                        ...
                        //call RegisterAT task, which will register the user
                        new RegisterAT(getApplicationContext(), email, nome, cognome, foto, bio, birth, sesso,
    ...
    /**
     * actions to be taken if user changes date of birth in the form
     * @param v
     */
    @Override
