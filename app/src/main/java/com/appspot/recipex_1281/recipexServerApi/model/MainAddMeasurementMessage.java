...
/**
 * Message used to add a Measurement Summary: This message class is intended to add a Measurement.
 * Attributes: kind = Measurement's kind [REQUIRED] systolic = Systolic pressure [REQUIRED IF KIND =
 * BP] diastolic = Diastolic pressure [REQUIRED IF KIND = BP] bpm = Heart beats per minute [REQUIRED
 * IF KIND = HR] respirations = Respirations done per minute [REQUIRED IF KIND = RR] spo2 = Pulse
 * Oximeter Oxigen Saturation [REQUIRED IF KIND = SpO2] hgt = Blood Sugar level [REQUIRED IF KIND =
 * HGT] degrees = Body temperature (in Celsius degrees) [REQUIRED IF KIND = TMP] nrs = Pain level
 * (0-10 scale) [REQUIRED IF KIND = PAIN] chl_level = Cholesterol level [REQUIRED IF KIND = CHL]
...
public final class MainAddMeasurementMessage extends com.google.api.client.json.GenericJson {
   ...
   */
  public MainAddMeasurementMessage setCalendarId(java.lang.String calendarId) {
