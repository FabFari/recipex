...
/**
 * Message to add a Prescription Summary: This message class is used to add a Prescription to a
 * specific User. This can be done by the User itself or by one of the User's Caregivers.
 * Attributes: name = Name of the Prescription's drug to take [REQUIRED] active_ingredient =
 * Datastore id of the Prescription's Active Ingredient entity [REQUIRED] kind = Kind of the
 * Prescription's drug [REQUIRED] dose = Dose of the Prescription's drug [REQUIRED] units = Unit of
 * measure of the drug's dose [REQUIRED] quantity = Number of assumptions per day [REQUIRED] recipe
 * = Boolean that states if the Prescription's drug need a medical recipe or not [REQUIRED] pil =
 * URL of the patient information leaflet (PIL) of the Prescription's drug caregiver = Datastore id
 * of the Caregiver's entity who prescribed the Prescription calendarIds = Google Calendar ids of
 * the Prescription's events [REQUIRED]
 *
