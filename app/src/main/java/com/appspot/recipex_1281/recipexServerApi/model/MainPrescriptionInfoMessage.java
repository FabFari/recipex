 ...
 * of the Prescription kind = Kind of the Prescription's drug dose = Dose of the Prescription's drug
 * units = Unit of measure of the drug's dose quantity = Number of assumptions per day recipe =
 ...
 * caregiver_mail = Email of the Caregiver caregiver_job = Kind of Caregiver (PC Physician, Visiting
 * Nurse or Caregiver) seen = Boolean value to track if the User saw the prescription or not
 * calendarIds = Google Calendar ids of the Prescription's events response = DefaultResponseMessage
...
public final class MainPrescriptionInfoMessage extends com.google.api.client.json.GenericJson {
   ...
   */
  public MainPrescriptionInfoMessage setCalendarIds(java.util.List<java.lang.String> calendarIds) {
