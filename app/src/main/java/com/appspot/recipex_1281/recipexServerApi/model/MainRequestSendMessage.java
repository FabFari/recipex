...
/**
 * Message to send a Request to a User Summary: This class is intended to send a Request to a
 * specific User within the application (i.e. Add a Request entity). Attributes: sender = Datastore
 * id of the User sender entity of the Request [REQUIRED] kind = Request's kind [REQUIRED] role =
 * Role of the sender User's entity in the request [REQUIRED IF KIND != RELATIVE] calendarId =
 * Google Calendar Id of the Sender User's Calendar [REQUIRED] message = Text message of the Request
 *
