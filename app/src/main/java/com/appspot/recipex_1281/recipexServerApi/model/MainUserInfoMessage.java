...
public final class MainUserInfoMessage extends com.google.api.client.json.GenericJson {
   ...
   */
  public MainUserInfoMessage setBusinessNums(java.util.List<java.lang.String> businessNums) {
   ...
   */
  public MainUserInfoMessage setPersonalNums(java.util.List<java.lang.String> personalNums) {
