...
/**
 * Message to register a User Summary: This Message Class is intended for register a User within the
 * application. Attributes: email = User's email [REQUIRED] name = User's first name [REQUIRED]
 * surname = User's last name [REQUIRED] birth = User's birth [REQUIRED] pic = URL to User's profile
 * pic [REQUIRED] sex = User's gender [REQUIRED] city = User's city address = User's address
 * personal_num = User's personal phone number field = Caregiver's field of specilization [REQUIRED
 * IF REGISTERING A CAREGIVER] years_exp = Caregiver's years of experience place = Caregiver's place
 * of work business_num = Caregivers' business phone number bio = Caregiver short biography
 * available = Caregiver's avalable days of the week calendarId = Id of the User's Google Calendar
...
public final class MainRegisterUserMessage extends com.google.api.client.json.GenericJson {
   ...
   */
  public MainRegisterUserMessage setBusinessNum(java.lang.String businessNum) {
   ...
   */
  public MainRegisterUserMessage setCalendarId(java.lang.String calendarId) {
   ...
   */
  public MainRegisterUserMessage setPersonalNum(java.lang.String personalNum) {
   ...
   */
  public MainRegisterUserMessage setPic(java.lang.String pic) {
    this.pic = pic;
    return this;
  }
