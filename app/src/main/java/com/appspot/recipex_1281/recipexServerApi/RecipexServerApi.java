...
public class RecipexServerApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Prescription {
     ...
     * @return the request
     */
    public AddPrescription addPrescription(java.lang.Long id, com.appspot.recipex_1281.recipexServerApi.model.MainAddMeasurementMessage content) throws java.io.IOException {
    ...
    public class AddPrescription extends RecipexServerApiRequest<com.appspot.recipex_1281.recipexServerApi.model.MainDefaultResponseMessage> {
       ...
       * @since 1.13
       */
      protected AddPrescription(java.lang.Long id, com.appspot.recipex_1281.recipexServerApi.model.MainAddMeasurementMessage content) {
        super(RecipexServerApi.this, "POST", REST_PATH, content, com.appspot.recipex_1281.recipexServerApi.model.MainDefaultResponseMessage.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
