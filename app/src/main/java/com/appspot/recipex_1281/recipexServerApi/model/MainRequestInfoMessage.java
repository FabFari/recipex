 ...
 * sender User's entity in the request [PRESENT IF KIND != RELATIVE] caregiver = Datastore id of the
 * Caregiver's entity [PRESENT IF KIND != RELATIVE] message = Text message of the Request pending =
 * Boolean value to track if the request is pending or not sender_pic = URL of the sender User
 * profile pic sender_name = Name of the sender User sender_surname = Surname of the sender User
 * sender_mail = E-Mail of the sender User calendarId = Google Calendar id of the Sender User's
 * Calendar [REQUIRED] response = DefaultREsponseMessage containing the response
 *
...
public final class MainRequestInfoMessage extends com.google.api.client.json.GenericJson {
   ...
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key("sender_mail")
  private java.lang.String senderMail;
   ...
   */
  public MainRequestInfoMessage setCalendarId(java.lang.String calendarId) {
  ...
  /**
   * @param senderMail senderMail or {@code null} for none
   */
  public MainRequestInfoMessage setSenderMail(java.lang.String senderMail) {
